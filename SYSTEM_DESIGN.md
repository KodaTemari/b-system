...
5) プール結果            ← リアルタイム結果表示（プールA,B,C…ごと）
...
**URL**: `https://boccia.app/event/{eventId}/results/pool`
...
# 結果表示
https://boccia.app/event/{eventId}/results/pool       // プール結果
https://boccia.app/event/{eventId}/results/tournament // トーナメント
```

**用語**: プール＝A,B,C…（リーグ単位）、コート＝1,2,3…（会場のコート番号）。プールAをコート1・2で同時に行う運用も可能。

**例**:
```
https://boccia.app/event/2026-tokyo/court/1/scoreboard?p=ctrl
https://boccia.app/event/2026-tokyo/results/pool
```
